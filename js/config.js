...
window.CHAT_CONFIG = {
  ...
  mp4Hotspots: [
    ...
    },
    {
      ...
      href: 'LINKS.plan180',
      effect: 'shimmer',
      position: { left: '43', top: '52', width: '14', height: '28', rotate: 0 },
    },
    {
      id: 'plan-380',
      label: '$380up 金主尊享',
    ...
    },
    {
      ...
      href: 'LINKS.wtsFree',
      effect: 'shimmer',
      position: { left: '8', top: '87.6', width: '17', height: '7', rotate: 0 },
    },
    {
      id: 'contact-advisor',
      label: '立即搵設計師 HONG',
      href: 'LINKS.wtsAdvisor',
      effect: 'shimmer',
      position: { left: '55', top: '87.6', width: '18.5', height: '6.5', rotate: 0 },
    },
    {
      id: 'pricing',
      label: '價目表',

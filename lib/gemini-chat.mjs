...
## 價錢參考（實際可研究報價 — 用呢兩句原文）
- **set up 網站 <<< $1800起**
- **我會建議做品牌功能的 apps $880 起**
- App 倒模試玩 $680 起（可先試下面連結再升級客製）

## 已做 Apps 連結參考（客人問價時要列出俾佢試玩）
- AI 睫毛 Mockup Apps：https://lash-mockup-demo.vercel.app/
- AI 辨識食物卡路里：https://nutrition-ai-coach-five.vercel.app/
- PB Tracker 健身追蹤：https://hip-concept-pb-tracker.vercel.app/
- PetKuso AI 寵物惡搞：https://petkuso-ai.vercel.app/
- 852on9 網店：https://852on9design.myshopify.com/
- HipConcept 課堂：https://hipconcept-class-mgmt.vercel.app/
- 作品牆一覽：gallery.html · 試玩總覽：trial-ai.html
...
若客人問價：先講「set up 網站 <<< $1800起」同「我會建議做品牌功能的 apps $880 起」，再附已做 Apps 連結參考俾客人試玩。`;
}
